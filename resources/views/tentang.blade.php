...
@section('content')
                    ...
                    <div id="carousel-example-generic" class="carousel carousel-fade slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item active">
                                <img class="img-responsive" src="{{ asset('front/assets/images/embun.jpeg') }}"
                                    alt="First slide">
                ...
                <div class="col-xs-12 col-md-12">
                    ...
                    <div class="card-container">
                        <div class="card card-shadow col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2 reveal">
                            ...
                            <form action="{{ route('feedback') }}" class="reveal-content" method="post" id="my-form">
                                @csrf
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" rows="3" placeholder="Enter your message" name="pesan"></textarea>
                                        </div>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\FeedbacknRequest', '#my-form') !!}
@endsection
